* Usage:
  ...
  | cdls | Command     | Description |
  |------|-------------|-------------|
  |*cdls* | ***/dir/name*** | Move to dir |
  | *cdls* | | Move to /home/$USER |
  |*cdls* | ***.*** |  Update current directory |
  |*cdls* | ***..*** |  Move up one directory |
  |*cdls* | ***-*** |  Move to previous directory |
